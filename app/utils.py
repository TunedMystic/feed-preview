...
def fetch_embed(url):
    """
    This function makes a response to the oEmbed provider
    and returns the html of the social embed.
    """

    # --------------------------
    # Temporary change
    #
    # We don't have a valid facebook token yet,
    # so we return a mock instagram response
    #
    if FB_TOKEN == 'token':
